 ...
 */
TREELITE_DLL int TreeliteLoadLightGBMModel(char const* filename, ModelHandle* out);
/*!
...
TREELITE_DLL int TreeliteLoadLightGBMModelEx(
    char const* filename, char const* config_json, ModelHandle* out);
/*!
 * \brief Deprecated. Please use \ref TreeliteLoadXGBoostModelEx instead.
 */
TREELITE_DLL int TreeliteLoadXGBoostModel(char const* filename, ModelHandle* out);
/*!
 ...
 */
TREELITE_DLL int TreeliteLoadXGBoostJSON(char const* filename, ModelHandle* out);
/*!
...
TREELITE_DLL int TreeliteLoadXGBoostJSONString(
    char const* json_str, size_t length, ModelHandle* out);
/*!
...
TREELITE_DLL int TreeliteLoadXGBoostModelFromMemoryBuffer(
    void const* buf, size_t len, ModelHandle* out);
/*!
 ...
 */
TREELITE_DLL int TreeliteLoadLightGBMModelFromString(char const* model_str, ModelHandle* out);
 ...
 * \return 0 for success, -1 for failure
 */
TREELITE_DLL int TreeliteBuildModelFromJSONString(
...
TREELITE_DLL int TreeliteLoadSKLearnIsolationForest(int n_estimators, int n_features,
    ...
    int64_t const** feature, double const** threshold, double const** value,
    int64_t const** n_node_samples, double const** weighted_n_node_samples, double const** impurity,
    double const ratio_c, ModelHandle* out);
...
TREELITE_DLL int TreeliteLoadSKLearnRandomForestClassifier(int n_estimators, int n_features,
    ...
    double const** impurity, ModelHandle* out);
...
TREELITE_DLL int TreeliteLoadSKLearnHistGradientBoostingClassifier(int n_iter, int n_features,
    ...
    double const** gain, double const* baseline_prediction, ModelHandle* out);
 ...
 */
TREELITE_DLL int TreeliteSerializeModel(char const* filename, ModelHandle handle);

/*!
 * \brief Deprecated. Please use \ref TreeliteDeserializeModelFromFile instead.
 */
TREELITE_DLL int TreeliteDeserializeModel(char const* filename, ModelHandle* out);
 ...
 * \return 0 for success, -1 for failure
 */
TREELITE_DLL int TreeliteSerializeModelToFile(ModelHandle handle, char const* filename);
 ...
 * \return 0 for success, -1 for failure
 */
TREELITE_DLL int TreeliteDeserializeModelFromFile(char const* filename, ModelHandle* out);
...
TREELITE_DLL int TreeliteDeserializeModelFromBytes(
    char const* bytes, size_t bytes_len, ModelHandle* out);
...
TREELITE_DLL int TreeliteConcatenateModelObjects(
    ModelHandle const* objs, size_t len, ModelHandle* out);
...
TREELITE_DLL int TreeliteDumpAsJSON(
    ModelHandle handle, int pretty_print, char const** out_json_str);
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteGTILParseConfig(char const* config_json, GTILConfigHandle* out);
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteGTILGetPredictOutputSizeEx(
 ...
 */
TREELITE_DLL int TreeliteGTILPredict(ModelHandle model, float const* input, size_t num_row,
    float* output, int nthread, int pred_transform, size_t* out_result_size);
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteGTILPredictEx(ModelHandle model, float const* input, size_t num_row,
    float* output, GTILConfigHandle config, size_t* out_result_size, size_t* out_result_ndim,
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteTreeBuilderCreateValue(
    void const* init_value, char const* type, ValueHandle* out);
/*!
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteCreateTreeBuilder(
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteTreeBuilderSetNumericalTestNode(TreeBuilderHandle handle, int node_key,
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteTreeBuilderSetCategoricalTestNode(TreeBuilderHandle handle, int node_key,
...
TREELITE_DLL int TreeliteTreeBuilderSetLeafVectorNode(
    TreeBuilderHandle handle, int node_key, ValueHandle const* leaf_vector, size_t leaf_vector_len);
/*!
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteCreateModelBuilder(int num_feature, int num_class, int average_tree_output,
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteModelBuilderSetModelParam(
 ...
 */
TREELITE_DLL int TreeliteModelBuilderInsertTree(
    ModelBuilderHandle handle, TreeBuilderHandle tree_builder, int index);
/*!
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteModelBuilderGetTree(
    ModelBuilderHandle handle, int index, TreeBuilderHandle* out);
/*!
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteModelBuilderDeleteTree(ModelBuilderHandle handle, int index);
/*!
 ...
 * \return 0 for success; -1 for failure
 */
TREELITE_DLL int TreeliteModelBuilderCommitModel(ModelBuilderHandle handle, ModelHandle* out);
/*! \} */
 ...
 */
TREELITE_DLL char const* TreeliteQueryTreeliteVersion(void);
